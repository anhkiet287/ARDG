...
| $\lambda_{\mathrm{lbl}}$ | Weight applied to label one-hot component of $\psi_i$. | `report/chapters/chapter4/5-clustering_feature.tex`; `tab:ch4_hparams`. | Chapters 4 and 5. | Default `0.1`. |
