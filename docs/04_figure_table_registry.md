...
|---|---|---|---|---|---|---|---|---|
| `fig:ch5_wandb_core_metrics` | `report/chapters/chapter5/9-tools_tracking.tex` | `figures/wandb/wb_train_loss.png`; `figures/wandb/wb_train_acc.png`; `figures/wandb/wb_val_clean_acc.png`; `figures/wandb/wb_pgd_linf_acc.png`; `figures/wandb/wb_ddn_l2_acc.png`; `figures/wandb/media_images_media_q_trajectory_15650_2752bccd0ffdd754ab89.png` | yes | `0.48\linewidth` subfigures | W&B dashboard exports for training loss, training accuracy, clean validation accuracy, PGD-`\ell_\infty` validation accuracy, DDN-`\ell_2` validation accuracy, and the AttackDRO++ group-weight trajectory. | yes | active | Six-panel tracking figure; Q-trajectory appears as panel (f). |
| `fig:ch5_q_trajectory` | `report/chapters/chapter5/9-tools_tracking.tex` | `figures/wandb/media_images_media_q_trajectory_15650_2752bccd0ffdd754ab89.png` | yes | `0.48\linewidth` subfigure | W&B export of the AttackDRO++ group-weight trajectory diagnostic. | no | active, unused | Subfigure label for panel (f) inside `fig:ch5_wandb_core_metrics`; not a separate numbered figure. |
...
| `tab:autoattack_fulltest` | `report/chapters/chapter6/1_main_results.tex` | Full-test AutoAttack-`\ell_\infty` results on a fixed random-seed panel. | `table + tabular` | yes | yes | active | Caption states delta direction against Multi-AT. |
