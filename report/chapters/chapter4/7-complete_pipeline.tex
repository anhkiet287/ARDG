...
Algorithm~\ref{alg:attackdropp} summarizes the complete AttackDRO++ training
...
uniform-anchored loss. Table~\ref{tab:hparams} lists the default hyperparameters
