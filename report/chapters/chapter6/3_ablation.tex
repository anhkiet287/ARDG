...
\begin{figure}[H]
    ...
    \caption{Sensitivity of AttackDRO++ to the number of clusters. Mean(8), Worst(8), and AutoAttack-$\ell_\infty$ are reported in percent. Mean(8) and Worst(8) are computed over the eight non-AutoAttack attacks; AutoAttack-$\ell_\infty$ is reported separately.}
...
\begin{figure}[H]
    ...
    \caption{Sensitivity of AttackDRO++ to the anchor strength $\lambda_{\mathrm{DRO}}$. Mean(8), Worst(8), and AutoAttack-$\ell_\infty$ are reported in percent. The previous $\lambda_{\mathrm{DRO}}=1.0$ setting is excluded from the final ablation panel.}
...
\begin{figure}[H]
    ...
    \caption{Sensitivity of AttackDRO++ to the cluster-refresh interval. Mean(8), Worst(8), and AutoAttack-$\ell_\infty$ are reported in percent. The two refresh schedules produce similar results, so the default two-epoch schedule is retained as a practical stability choice.}
