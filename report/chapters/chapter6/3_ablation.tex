...
main comparison or theoretical proof. Each setting uses the available runs under
the same CIFAR-10, ResNet-18, source-attack, and evaluation-attack protocol
