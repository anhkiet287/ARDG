...
sections: the hardest \(\ell_\infty\) stress metrics are broadly unchanged relative to
Multi-AT, while the main benefit of AttackDRO++ is on average and held-out robustness.
