...
the selected $n=5$ seed panel. AutoAttack is therefore a separate stress check,
not part of Mean(8) or the main aggregate ranking.
...
observed lower seed-to-seed standard deviation, decreasing from \(0.447\)~pp
under Multi-AT to \(0.148\)~pp under AttackDRO++, a \(3.03\times\) ratio.
