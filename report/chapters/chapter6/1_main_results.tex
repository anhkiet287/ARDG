...
Mean robust accuracy denotes Mean(8), the average robust accuracy over the
eight non-AutoAttack evaluation attacks. Worst-case robust accuracy denotes
Worst(8), the lowest robust accuracy among those same eight attacks. The
