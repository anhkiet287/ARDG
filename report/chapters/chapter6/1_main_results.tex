...
Mean(8) averages the eight non-AutoAttack evaluation attacks. The held-out
attack mean averages the six evaluation attacks not used as source attacks:
FGSM-RS, TPGD, MI-FGSM, PGD-$\ell_2$, DeepFool-$\ell_2$, and CW-$\ell_2$.
The held-out $\ell_\infty$ mean averages FGSM-RS, TPGD, and MI-FGSM; the
held-out $\ell_2$ mean averages PGD-$\ell_2$, DeepFool-$\ell_2$, and
CW-$\ell_2$. The seen-source mean averages PGD-$\ell_\infty$ and
DDN-$\ell_2$. AutoAttack is reported separately and is not included in
Mean(8). Bold values indicate the best method for each metric.}
...
\quad Held-out $\ell_\infty$ mean
& $\mathbf{62.515 \pm 0.334}$
& $51.594 \pm 0.306$
& $60.916 \pm 0.427$
& $61.149 \pm 0.170$ \\

\quad Held-out $\ell_2$ mean
& $62.021 \pm 0.474$
...
14/20 wins), with the strongest channel on held-out $\ell_2$ attacks ($+0.405$~pp,
...
(PGD-AT on held-out $\ell_\infty$, DDN-AT on held-out $\ell_2$) but lose
...
\midrule
 ...
 Multi-AT & Held-out attack mean & 20 & $+0.319$ & $0.478$ & $13/20$ & $0.667$ & $\mathbf{0.0076}$ \\
 Multi-AT & Held-out $\ell_\infty$ mean & 20 & $+0.233$ & $0.412$ & $14/20$ & $0.566$ & $0.0204$ \\
 Multi-AT & Held-out $\ell_2$ mean & 20 & $+0.405$ & $0.609$ & $16/20$ & $0.664$ & $\mathbf{0.0079}$ \\
...
PGD-AT & Held-out attack mean & 20 & $+2.134$ & $0.378$ & $20/20$ & $5.650$ & $\mathbf{<10^{-10}}$ \\
PGD-AT & Held-out $\ell_\infty$ mean & 20 & $-1.366$ & $0.320$ & $0/20$ & $-4.273$ & $\mathbf{<10^{-10}}$ \\
PGD-AT & Held-out $\ell_2$ mean & 20 & $+5.633$ & $0.484$ & $20/20$ & $11.638$ & $\mathbf{<10^{-20}}$ \\
PGD-AT & Seen-source mean & 20 & $+0.901$ & $0.197$ & $20/20$ & $4.585$ & $\mathbf{<10^{-10}}$ \\
...
DDN-AT & Held-out attack mean & 20 & $+4.774$ & $0.282$ & $20/20$ & $16.910$ & $\mathbf{<10^{-20}}$ \\
DDN-AT & Held-out $\ell_\infty$ mean & 20 & $+9.555$ & $0.376$ & $20/20$ & $25.440$ & $\mathbf{<10^{-20}}$ \\
DDN-AT & Held-out $\ell_2$ mean & 20 & $-0.008$ & $0.319$ & $10/20$ & $-0.025$ & $0.914$ \\
DDN-AT & Seen-source mean & 20 & $+10.073$ & $0.318$ & $20/20$ & $31.723$ & $\mathbf{<10^{-20}}$ \\
...
%   - Held-out attack mean: average over held-out Linf + held-out L2 attacks.
%   - Held-out Linf mean: FGSM-RS, TPGD, MI-FGSM.
%   - Held-out L2 mean: PGD-L2, DeepFool-L2, CW-L2.
%   - Seen-source mean: PGD-Linf and DDN-L2.
...
%   Clean, Mean(8), held-out attack mean, held-out Linf mean, held-out L2 mean,
%   seen-source mean, Worst(8).
% ────────────────────────────────────────────────────────────────────────────
...
%         strongest channel on held-out $\ell_2$ ($+0.405$~pp, $p = 0.0079$,
...
%         held-out $\ell_2$ attacks individually significant at $p < 0.01$.
