...
\label{subsec:ch6_aggregate_robustness}
...
separately in Section~\ref{subsec:ch6_worst_case_behavior}.
...
% in Section~\ref{subsec:ch6_worst_case_behavior}.
%
% Method names:
...
from this table and reported separately in Section~\ref{subsec:ch6_worst_case_behavior}.}
...
\label{subsec:ch6_per_attack_breakdown}
...
\label{subsec:ch6_worst_case_behavior}
...
\label{subsec:ch6_variance_reduction}
