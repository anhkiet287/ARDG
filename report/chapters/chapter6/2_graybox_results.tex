...
\begin{table}[H]
\centering
\caption{Whitebox sanity check from the graybox pipeline. The five-random-seed
columns use diagonal graybox entries, where surrogate and target are the
same checkpoint. The 20-random-seed columns report the main whitebox results
from Table~\ref{tab:ch6_aggregate_results}. Bold values indicate the best method for each metric.}
...
\midrule
PGD-AT
& $61.524$ & \bestval{50.384} & $60.499$ & \bestval{49.656} \\
DDN-AT
& $56.922$ & $25.568$ & $56.226$ & $25.957$ \\
Multi-AT
& $62.458$ & $45.584$ & $62.045$ & $45.082$ \\
AttackDRO++ (Ours)
& \bestval{62.642} & $45.088$ & \bestval{62.324} & $45.079$ \\
\bottomrule
\end{tabular}
\end{table}
...
$>$ Multi-AT ($72.36\%$) $>$ PGD-AT ($70.59\%$). The DDN-AT
...
row is consistently above the Multi-AT row for every surrogate,
...
over Multi-AT therefore persists when adversarial examples are
...
Significance is reported in the \(p\)-value column.}
...
\midrule
FGSM-RS         & held-out $\ell_\infty$ & $73.32$ & $72.86$ & $+0.454$ & $0.0114$ \\
PGD-$\ell_\infty$ & seen $\ell_\infty$    & $57.17$ & $57.07$ & $+0.102$ & $0.307$  \\
TPGD            & held-out $\ell_\infty$ & $73.09$ & $72.30$ & $+0.790$ & $0.0240$ \\
MI-FGSM         & held-out $\ell_\infty$ & $55.20$ & $54.75$ & $+0.458$ & $0.0022$ \\
\midrule
PGD-$\ell_2$    & held-out $\ell_2$      & $74.97$ & $74.53$ & $+0.432$ & $0.0373$ \\
DDN-$\ell_2$    & seen $\ell_2$          & $76.04$ & $75.79$ & $+0.256$ & $0.341$  \\
DeepFool-$\ell_2$ & held-out $\ell_2$    & $80.29$ & $78.82$ & $+1.469$ & $0.0002$ \\
...
Bold values indicate the best method for each metric.}
...
\midrule
PGD-AT & \bestval{61.48} & $72.61$ & $68.93$           & $74.60$           & $70.59$ \\
DDN-AT      & $56.58$          & \bestval{84.03} & $68.60$ & \bestval{84.85}  & \bestval{75.12} \\
Multi-AT  & $59.71$          & $77.40$          & $68.64$ & $78.62$           & $72.36$ \\
AttackDRO++ (Ours) & $59.96$          & $77.78$          & \bestval{69.18} & $79.35$ & $72.92$ \\
\bottomrule
\end{tabular}
\end{table}
...
The graybox analysis tests whether the whitebox pattern survives transfer from
independently trained surrogate checkpoints. It supports the same broad
interpretation as the direct whitebox evaluation, but transfer matrices and
paired comparisons do not identify which design choices make AttackDRO++ stable.
The next section therefore turns to hyperparameter sensitivity, focusing on
cluster granularity, anchor strength, and refresh frequency.

% Section summary removed from the numbered structure.
\iffalse
