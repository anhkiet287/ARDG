...
\label{subsec:ch6_graybox_panel}
...
\label{subsec:ch6_graybox_matrix}
...
Section~\ref{subsec:ch6_graybox_gap} quantifies this structural inflation
...
\label{subsec:ch6_graybox_headline}
...
this asymmetry in Section~\ref{subsec:ch6_graybox_gap}.

\subsection{Per-Attack Analysis}
\label{subsec:ch6_graybox_per_attack}
...
\label{subsec:ch6_graybox_per_cell}
...
(Section~\ref{subsec:ch6_per_attack_breakdown}).
...
\label{subsec:ch6_graybox_decomposition}
...
Section~\ref{subsec:ch6_graybox_headline}. Second, the Cluster-DRO effect is
...
\label{subsec:ch6_graybox_section_summary}
