...
% TODO[Kiệt]:
% Goal:
% - Make dataset split and preprocessing choices fully reproducible.
% Flow:
% - Dataset identity, split sizes, augmentation, normalization, validation/test separation.
% Include:
% - State clearly that all methods use identical dataloaders and preprocessing.
% Avoid:
% - Method comparison or result interpretation.
