...
For AttackDRO and AttackDRO++, the logged group weights and cluster diagnostics
are particularly useful for checking whether adaptive reweighting behaves as
expected, but these diagnostics are not used to select test results directly.
