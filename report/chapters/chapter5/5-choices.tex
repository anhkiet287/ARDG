...
% Include:
% - Keep values synchronized with Chapter 4 `tab:ch4_hparams` and Chapter 6 ablation tables.
% Avoid:
...
Table~\ref{tab:ch5_ablation_hyperparams} lists the main hyperparameters varied in ablation
