...
% TODO[Kiệt]:
% Goal:
% - Describe the controlled training setup that makes method comparisons fair.
% Flow:
% - Optimizer, schedule, epochs, batch construction, checkpoint selection, and method summary.
% Include:
% - Keep method names in formal tables as PGD-AT, DDN-AT, Multi-AT, AttackDRO, AttackDRO++, and AttackDRO++ (Ours).
% Avoid:
% - Explaining method internals already covered in Chapter 4.
...
The primary training configuration is summarized in Table~\ref{tab:training_config}.
...
Table~\ref{tab:method_training_summary} summarizes the main training methods. All
...
\label{tab:method_training_summary}
\footnotesize
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.08}
\begin{tabularx}{\textwidth}{@{}
