...
% TODO[Kiệt]:
% Goal:
% - Explain the statistical protocol as the contract for Chapter 6 claims.
% Flow:
% - Paired seed design, tests, effect size, confidence intervals, and correction.
% Include:
% - Keep terms consistent with docs/05_notation_registry.md and Chapter 2 statistical background.
% Avoid:
% - Overstating significance when effect sizes or corrected p-values are weak.
% Target length: 5-7 paragraphs plus reporting-format table.
...
The reporting format used in the results chapter is summarized in Table~\ref{tab:ch5_statistical_reporting_format}.
