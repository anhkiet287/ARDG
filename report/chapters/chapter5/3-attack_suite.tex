...
\begin{table}[H]
\centering
\caption{Source attack configuration used during training. Both attacks are used to generate mixed adversarial minibatches for the multi-attack design path from Multi-AT through AttackDRO++.}
