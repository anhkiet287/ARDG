...
\subsection{Grouped Adversarial Perturbation Visualization}

Figure~\ref{fig:app_grouped_l2_adv_viz} summarizes adversarial examples and
normalized perturbation heatmaps across the main \(\ell_2\) evaluation attacks.
This figure is intended as qualitative support for the attack descriptions in
Chapter~2; all heatmaps are normalized for visibility.
